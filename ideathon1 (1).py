...
Original file is located at
    https://colab.research.google.com/drive/1FWompvQfnMSa-IYMSn-LMG1k5ILRLgqQ
"""
...
if climate_data_file and province_detail_file and station_detail_file:
    ...
    if set(features).issubset(final_dataset.columns) and target in final_dataset.columns:
        ...
        for i in range(min(5, len(y_test))):
            st.write(f"Actual: {y_test.iloc[i]}, Predicted: {y_pred[i]}")
        ...
        shap.initjs()
        st.pyplot(shap.force_plot(explainer.expected_value, shap_values[feedback_index], X_test.iloc[feedback_index], matplotlib=True))
